...
//        request.setAttribute("user", studentDAO.get(uid));
	...
	public String beforeReserve(HttpServletRequest request, HttpServletResponse response, Page page) {
		...
		List<RepairActivity> activities = repairActivityDAO.ListAll();
...
//        Student student = studentDAO.get(Integer.parseInt(parameters.get("userId")));
		...
		request.setAttribute("backLink",
				"makeReservation?method=confirmInformation");
...
//        Student student = studentDAO.get(Integer.parseInt(parameters.get("userId")));
		...
		request.setAttribute("message", "您的预约已提交");
		request.setAttribute("backLink",
				"makeReservation?method=confirmInformation&uid=" + request.getParameter("userId"));
	 ...
	 * (non-Javadoc)
	 * 
	 * @see xiuxiuxiu.servelt.BaseServlet#add(javax.servlet.http.HttpServletRequest,
	 * javax.servlet.http.HttpServletResponse, xiuxiuxiu.util.Page)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * xiuxiuxiu.servelt.BaseServlet#delete(javax.servlet.http.HttpServletRequest,
	 * javax.servlet.http.HttpServletResponse, xiuxiuxiu.util.Page)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * xiuxiuxiu.servelt.BaseServlet#edit(javax.servlet.http.HttpServletRequest,
	 * javax.servlet.http.HttpServletResponse, xiuxiuxiu.util.Page)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * xiuxiuxiu.servelt.BaseServlet#update(javax.servlet.http.HttpServletRequest,
	 * javax.servlet.http.HttpServletResponse, xiuxiuxiu.util.Page)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * xiuxiuxiu.servelt.BaseServlet#list(javax.servlet.http.HttpServletRequest,
	 * javax.servlet.http.HttpServletResponse, xiuxiuxiu.util.Page)
	 */
	@Override
